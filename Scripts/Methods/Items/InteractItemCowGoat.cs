...
namespace Atbt.Item {
public class InteractItemCowGoat : InteractItemAnimal {
#region -------------------- Private Variables --------------------
    [SerializeField] private List<ItemObject> _milkItems;

    private QualityTypeEnum _lowestQualityRequired = QualityTypeEnum.Base;

    private ToolTypeEnum[] _requiredTools = { ToolTypeEnum.MilkPail };
#endregion
