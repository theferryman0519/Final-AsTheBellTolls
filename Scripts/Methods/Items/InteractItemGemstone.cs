...
namespace Atbt.Item {
public class InteractItemGemstone : InteractModel {
#region -------------------- Private Variables --------------------
    [SerializeField] private ItemObject _gemstoneItem;
    [SerializeField] private QualityTypeEnum _lowestQualityRequired;
