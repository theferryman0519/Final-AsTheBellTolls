...
namespace Atbt.Item {
public class InteractItemHerbBush : InteractModel {
#region -------------------- Private Variables --------------------
    [SerializeField] private List<ItemObject> _herbItems;

    private QualityTypeEnum _lowestQualityRequired = QualityTypeEnum.Base;

    private ToolTypeEnum[] _requiredTools = { ToolTypeEnum.HerbKnife };
#endregion
