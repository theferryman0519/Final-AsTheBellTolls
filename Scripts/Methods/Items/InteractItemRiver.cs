...
namespace Atbt.Item {
public class InteractItemRiver : InteractModel {
#region -------------------- Private Variables --------------------
    [SerializeField] private List<ItemObject> _fishItems;

    private QualityTypeEnum _lowestQualityRequired = QualityTypeEnum.Base;

    private ToolTypeEnum[] _requiredTools = { ToolTypeEnum.FishingNet, ToolTypeEnum.FishingRod };
#endregion
